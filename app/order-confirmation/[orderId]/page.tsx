  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold mb-2 font-bengali">অর্ডার সম্পন্ন!</h1>
        <p className="text-gray-500 font-bengali">ধন্যবাদ! শীঘ্রই ফোনে কনফার্ম করা হবে।</p>
      </div>
      ...
      <div className="card p-6 mb-6">
        ...
        <div className="border-t pt-4 mb-4">
          <h2 className="font-semibold mb-2 font-bengali">পণ্যসমূহ</h2>
          {order.items.map((item, i) => {
            const fp = getFinalPrice(item);
            return (
              <div key={i} className="flex justify-between py-2 text-sm">
                <span className="font-bengali">{item.productName} ×{item.quantity}</span>
        ...
        <div className="border-t pt-4 space-y-2 text-sm">
          ...
          <div className="border-t pt-2 flex justify-between font-bold text-lg"><span>সর্বমোট</span><span className="text-gold">৳{order.grandTotal.toFixed(0)}</span></div>
        </div>
      </div>

      <div className="card p-6 mb-6">
        <h2 className="font-semibold mb-3 font-bengali">ডেলিভারি তথ্য</h2>
        <div className="text-sm space-y-1 font-bengali">
      ...
      <div className="card p-6 mb-6">
        <h2 className="font-semibold mb-3 font-bengali">পেমেন্ট</h2>
